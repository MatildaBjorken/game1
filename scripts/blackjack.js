    ...
    players.players().map((player) => {
      if (player.id === activePlayer.id) {
        ...
        if (player.type === 'human') {
          ...
          btn_hit.className = 'btn';
          btn_stay.className = 'btn';

          btn_hit.innerHTML = 'Hit me!';
          btn_hit.addEventListener(
            'click',
            function () {
              hit(player);
            },
          ...
          document
            .getElementById('actions_' + player.id)
            .appendChild(div_buttons);
        }
      } else {
        document
          .getElementById('player_' + player.id)
